...
class FeedbackService:
    ...
    @staticmethod
    def create_feedback(db: Session, feedback_data: FeedbackCreate, user_id: int) -> Feedback:
        """Create new feedback"""
    ...
    @staticmethod
    def get_all_feedback(db: Session, skip: int = 0, limit: int = 100) -> List[FeedbackWithUser]:
